...
![image](https://user-images.githubusercontent.com/57148042/73182449-61dbbd00-4119-11ea-9c8d-6c47986eeb64.png)

It reveals another hidden code to decipher, as well as some logged conversation in the javascript console about a drawer. Deciphering the code is straight forward, each number corresponds to a letter in the alphabet given underneath, giving us `it opens [.html]`

By realizing that 'it opens' refers to the drawer, and adding '.html' to it, we get a `drawer.html` page to visit, again no different than the first one. We then just need to look at the source code again to get our flag :

![image](https://user-images.githubusercontent.com/57148042/73182917-373e3400-411a-11ea-9168-ac3dcd1a05d8.png)
